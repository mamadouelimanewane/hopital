...
export function Navbar() {
  ...
  return (
    <header style={{ background: "#14b8a6", boxShadow: "0 2px 12px rgba(0,0,0,0.15)", position: "sticky", top: 0, zIndex: 50 }}>
      <div style={{ background: "#0a1628", padding: "4px 16px", textAlign: "center" }}>
        <p style={{ fontSize: 11, color: "#5eead4", margin: 0, letterSpacing: "0.08em" }}>
