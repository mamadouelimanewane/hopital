...
export default function NeuroScan() {
  ...
  return (
    <>
      ...
      {/* HEADER */}
      <header className="glass-panel sticky top-[52px] z-50 flex flex-col sm:flex-row items-center justify-between px-4 sm:px-6 py-3 mx-2 sm:mx-4 mt-4 border-b-0">
