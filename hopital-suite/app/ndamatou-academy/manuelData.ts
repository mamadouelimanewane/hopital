...
export const manuelApps: ManuelApp[] = [
  ...
  // ---------- E. Extensions Avancées ----------
  {
    id: "bloc-operatoire", nom: "Bloc Opératoire", route: "/bloc-operatoire", icone: "🔪", categorie: "clinique",
    objectif: "Planifier les salles d'opération et sécuriser le déroulement des interventions chirurgicales.",
    roles: ["Chirurgien", "Anesthésiste", "Cadre de bloc", "Infirmier de bloc"],
    fonctionnalites: ["Planning des salles d'opération", "Checklist sécurité chirurgicale OMS", "Suivi temps réel (installation, incision, fermeture)", "Traçabilité de l'équipe et du matériel"],
    guide: [
      "Consulter le planning du jour pour connaître l'ordre de passage par salle.",
      "Faire valider la checklist de sécurité OMS avant l'incision.",
      "Mettre à jour le statut de la salle à chaque étape de l'intervention.",
      "Clôturer l'intervention et enregistrer le compte-rendu opératoire.",
    ],
    conseils: ["Ne jamais ignorer un item de la checklist OMS, même en cas d'urgence apparente."],
  },
  {
    id: "urgences", nom: "Urgences SAU", route: "/urgences", icone: "🚨", categorie: "clinique",
    objectif: "Piloter en temps réel le flux de patients du Service d'Accueil des Urgences.",
    roles: ["Infirmier d'accueil et d'orientation", "Médecin urgentiste", "Cadre des urgences"],
    fonctionnalites: ["Vue des box en temps réel", "Classification de gravité P1 à P4", "Alerte de saturation", "Liaison avec Triage IA et AmbuTrack"],
    guide: [
      "Enregistrer le patient à son arrivée et vérifier la priorité proposée par Triage IA.",
      "Affecter un box disponible selon la gravité.",
      "Surveiller les temps d'attente et réagir aux alertes de saturation.",
      "Mettre à jour le statut du patient jusqu'à sa sortie ou son transfert.",
    ],
    conseils: ["Réévaluer régulièrement les patients en salle d'attente, une priorité peut évoluer rapidement."],
  },
  {
    id: "imagerie", nom: "Imagerie PACS/RIS", route: "/imagerie", icone: "🩻", categorie: "clinique",
    objectif: "Gérer le workflow complet de radiologie, de la demande d'examen à l'archivage du compte-rendu.",
    roles: ["Manipulateur radio", "Radiologue", "Médecin prescripteur"],
    fonctionnalites: ["Réception des demandes d'imagerie", "Visualisation DICOM", "Compte-rendu structuré", "Archivage et interopérabilité avec DMP-Gateway"],
    guide: [
      "Réceptionner la demande d'examen envoyée par le service prescripteur.",
      "Réaliser l'examen et charger les images dans le système.",
      "Rédiger le compte-rendu à partir du modèle correspondant à l'examen.",
      "Valider le compte-rendu ; il devient consultable par le service prescripteur.",
    ],
    conseils: ["Signaler immédiatement toute découverte fortuite critique, sans attendre la validation finale du compte-rendu."],
  },
  {
    id: "ias-watch", nom: "IAS-Watch", route: "/ias-watch", icone: "🦠", categorie: "admin",
    objectif: "Surveiller les infections associées aux soins (IAS) et détecter précocement les clusters.",
    roles: ["Hygiéniste hospitalier", "Responsable qualité", "Chef de service"],
    fonctionnalites: ["Signalement d'infection nosocomiale", "Cartographie par service", "Suivi des mesures correctives", "Alerte de cluster épidémique interne"],
    guide: [
      "Signaler toute suspicion d'infection associée aux soins dès son identification.",
      "Consulter la cartographie pour repérer une concentration anormale de cas.",
      "Assigner et suivre les mesures correctives jusqu'à leur clôture.",
      "Traiter en priorité toute alerte de cluster.",
    ],
    conseils: ["Croiser les données avec Épidémio-Watch en cas de suspicion d'origine extérieure à l'établissement."],
  },
  {
    id: "proches-aidants", nom: "Proches-Aidants", route: "/proches-aidants", icone: "👨‍👩‍👧", categorie: "evenementiel",
    objectif: "Permettre aux familles de suivre à distance l'hospitalisation d'un proche.",
    roles: ["Famille du patient", "Secrétariat médical", "Personnel soignant"],
    fonctionnalites: ["Statut d'hospitalisation en direct", "Messagerie sécurisée avec le service", "Réservation de créneaux de visite", "Notifications aux étapes clés"],
    guide: [
      "Le proche référent est enregistré avec l'accord du patient à l'admission.",
      "Il consulte le statut d'hospitalisation mis à jour par le service.",
      "Il peut échanger via la messagerie sécurisée avec l'équipe soignante.",
      "Il réserve un créneau de visite selon les disponibilités du service.",
    ],
    conseils: ["Vérifier systématiquement le consentement du patient avant d'activer le suivi pour un proche."],
  },
  {
    id: "consentement", nom: "Consentement Éclairé", route: "/consentement", icone: "✍️", categorie: "admin",
    objectif: "Recueillir électroniquement le consentement du patient avant tout acte médical ou chirurgical.",
    roles: ["Médecin ou chirurgien référent", "Patient", "Secrétariat médical"],
    fonctionnalites: ["Génération du document adapté à l'acte", "Signature électronique horodatée", "Archivage sécurisé et opposable", "Historique consultable par le patient"],
    guide: [
      "Générer le document de consentement correspondant à l'acte prévu.",
      "Expliquer l'acte, ses risques et alternatives au patient avant signature.",
      "Faire signer électroniquement le patient ou son représentant légal.",
      "Vérifier l'archivage du document dans le dossier du patient.",
    ],
    conseils: ["Le consentement doit toujours être précédé d'une information orale claire — le document ne s'y substitue pas."],
  },
  {
    id: "bien-etre-soignant", nom: "Bien-Être Soignant", route: "/bien-etre-soignant", icone: "🧘", categorie: "admin",
    objectif: "Prévenir le burn-out et suivre de façon confidentielle le climat social du personnel.",
    roles: ["Personnel médical et paramédical", "Responsable RH", "Cellule de soutien psychologique"],
    fonctionnalites: ["Enquête de climat social anonyme", "Détection précoce du risque de burn-out", "Prise de rendez-vous avec la cellule de soutien", "Suivi agrégé et confidentiel par service"],
    guide: [
      "Répondre à l'enquête de climat social envoyée périodiquement.",
      "Consulter, en tant que responsable, les indices agrégés par service (jamais individuels).",
      "Orienter le personnel d'un service en vigilance vers la cellule de soutien.",
      "Prendre rendez-vous directement depuis le module en cas de besoin.",
    ],
    conseils: ["Garantir l'anonymat des réponses est la condition de la fiabilité de l'outil — ne jamais tenter de désanonymiser les résultats."],
  },
  {
    id: "sterilisation", nom: "Stérilisation", route: "/sterilisation", icone: "🧼", categorie: "admin",
    objectif: "Assurer la traçabilité complète du matériel stérilisé, du prélavage jusqu'au bloc opératoire.",
    roles: ["Agent de stérilisation", "Cadre de bloc", "Responsable hygiène"],
    fonctionnalites: ["Traçabilité par instrument et par lot", "Contrôle des indicateurs biologiques de cycle", "Alerte de rupture de charge stérile", "Historique par intervention chirurgicale"],
    guide: [
      "Enregistrer le lot d'instruments au moment du prélavage.",
      "Suivre le cycle de stérilisation et contrôler l'indicateur biologique.",
      "Valider la conformité du lot avant sa mise en stock stérile.",
      "Associer le lot utilisé à l'intervention chirurgicale correspondante.",
    ],
    conseils: ["Isoler immédiatement tout lot non conforme et ne jamais l'utiliser en attendant une nouvelle stérilisation."],
  },
  {
    id: "cyber-soc", nom: "Cyber-SOC", route: "/cyber-soc", icone: "🛡️", categorie: "admin",
    objectif: "Surveiller en continu la sécurité informatique des systèmes critiques de l'hôpital.",
    roles: ["Analyste sécurité (SOC)", "Administrateur système", "RSSI"],
    fonctionnalites: ["Surveillance continue des systèmes critiques (DMP, PACS, facturation)", "Détection d'intrusion et d'anomalies", "Playbooks de réponse à incident", "Tableau de conformité (chiffrement, accès)"],
    guide: [
      "Surveiller le tableau de bord des alertes en continu.",
      "Qualifier la sévérité de chaque alerte et déclencher le playbook correspondant.",
      "Escalader immédiatement tout incident touchant des données de santé.",
      "Documenter la résolution et mettre à jour les règles de détection si nécessaire.",
    ],
    conseils: ["Toute alerte touchant DMP-Gateway ou les dossiers patients est traitée en priorité absolue, quelle que soit la sévérité initiale."],
  },
  {
    id: "maintenance-batiment", nom: "Maintenance Bâtiment", route: "/maintenance-batiment", icone: "🏗️", categorie: "evenementiel",
    objectif: "Gérer la maintenance générale des infrastructures : ascenseurs, CVC, électricité, plomberie.",
    roles: ["Technicien de maintenance générale", "Responsable technique", "Personnel des services"],
    fonctionnalites: ["Signalement de panne par service", "Planning de maintenance préventive", "Suivi des prestataires externes", "Historique par bâtiment"],
    guide: [
      "Signaler une panne depuis le service concerné avec description et localisation.",
      "Le responsable technique priorise et planifie l'intervention.",
      "Suivre l'intervention jusqu'à sa résolution, y compris pour les prestataires externes.",
      "Consulter l'historique du bâtiment pour anticiper les besoins de maintenance préventive.",
    ],
