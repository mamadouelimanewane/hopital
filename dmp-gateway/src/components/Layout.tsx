...
import {
  LayoutDashboard, FolderKanban, Cable, ScrollText, Network, ShieldCheck,
  Settings, Bell, Search, Menu, Globe2, X, ChevronRight,
...
const navigation = [
  ...
  { name: 'Dossiers Partagés',    href: '/dossiers',     icon: FolderKanban,    badge: null },
  { name: 'Connecteurs',          href: '/connecteurs',  icon: Cable,           badge: null },
  { name: 'Journal Synchro',      href: '/journal',      icon: ScrollText,      badge: null },
  { name: 'Réseau',               href: '/reseau',        icon: Network,         badge: null },
  { name: 'Sécurité',             href: '/securite',      icon: ShieldCheck,     badge: null },
];
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-5"
          ...
          <div className="flex items-center gap-2.5">
            <div className="p-1.5 rounded-lg bg-emerald-500/10 text-xl leading-none">
              🌍
            </div>
            <div>
              <span className="text-sm font-bold tracking-tight" style={{ color: 'var(--text-primary)' }}>DMP-Gateway</span>
              <div className="text-[10px] leading-none" style={{ color: 'var(--text-muted)' }}>Interopérabilité HL7/FHIR</div>
            </div>
          </div>
        ...
        <header className="h-16 sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6 backdrop-blur-xl"
          ...
          <div className="flex-1 max-w-md mx-4 hidden md:block">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Rechercher un dossier, connecteur…"
                value={searchQuery}
