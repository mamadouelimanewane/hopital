...
for (const [appId, data] of Object.entries(APPS)) {
  ...
  if (appId !== 'chncak-predict-ia') {
      ...
      // Pour predict-ia, on remplace CNRA par CHNCAK
...
if (fs.existsSync(suitePagePath)) {
  ...
  suiteContent = suiteContent.replace(/Conseil National de Régulation de l'Audiovisuel/g, "Centre Hospitalier National Cheikh Ahmadoul Khadim");
