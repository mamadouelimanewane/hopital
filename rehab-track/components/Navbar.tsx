...
export function Navbar() {
  ...
  return (
    <header style={{ background: "#16a34a", boxShadow: "0 2px 12px rgba(0,0,0,0.15)", position: "sticky", top: 0, zIndex: 50 }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          ...
          <div>
            <p style={{ fontSize: 15, fontWeight: 800, color: "#fff", margin: 0 }}>RehabTrack</p>
