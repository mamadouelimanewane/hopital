...
const SEED_NOTIFICATIONS: Notification[] = [
  {
    id: 'N001', type: 'warning', read: false, ts: new Date(Date.now() - 3600000),
    title: 'Rupture imminente — Riz brisé',
    message: 'Stock cuisine sous le seuil minimum (12 kg restants). Réassort recommandé.',
  },
  {
    id: 'N002', type: 'error', read: false, ts: new Date(Date.now() - 7200000),
    title: 'Livraison non conforme',
    message: 'La livraison LIV-014 de Sénégal Linge Pro présente des articles endommagés.',
  },
  {
    id: 'N003', type: 'info', read: false, ts: new Date(Date.now() - 10800000),
    title: 'Commande confirmée',
    message: 'CMD-108 auprès de Touba Alimentation Gros a été confirmée par le fournisseur.',
  },
  {
    id: 'N004', type: 'success', read: true, ts: new Date(Date.now() - 86400000),
    title: 'Livraison reçue et conforme',
    message: 'LIV-011 — Fournitures de bureau réceptionnées sans anomalie.',
  },
];
